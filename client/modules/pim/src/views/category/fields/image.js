...
Espo.define('pim:views/category/fields/image', 'views/fields/image',
    Dep => Dep.extend({
        ...
        setup() {
            ...
            this.listenTo(this.model, 'updateCategoryImage', () => {
                this.getMainImage();
            });
        ...
        getMainImage() {
            if (this.model.id) {
                this.ajaxGetRequest(`Category/${this.model.id}/categoryImages`, {
                    maxSize: 1,
                    offset: 0
                })
                    .then(data => {
